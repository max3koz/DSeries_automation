...
from constants import path_to_project
...
def test_create_session_positive(schedule_window=100, as_run_log_window =100):
...
def test_ping_session_positive(schedule_window=16, as_run_log_window=16):
    session_id = create_session(schedule_window, as_run_log_window)
...
def test_delete_session_positive(schedule_window=16, as_run_log_window=16):
    session_id = create_session(schedule_window, as_run_log_window)
